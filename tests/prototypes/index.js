...
describe('blackstone', function(){
    describe('prototypes', function(){
        ...
        var prototypes = blackstone.prototypes;
        
        it('should be a object', function(){
            prototypes.should.have.type('object');
        });
        
        describe('Prototype', function(){
            
            var Prototype = prototypes.Prototype;
            ...
            describe('prototype', function(){
                ...
                it('should have an index of 0 prototype', function(){
                    prototype.index.should.be.eql(1);
                });
                ...
                describe('prototype.new', function(){
                    ...
                    it('should return instance', function(){
                        ...
                        instance.should.be.an.instanceof(prototypes.Instance);
                    });
                });
                
                describe('Instance', function(){
                    
                    var Instance = prototypes.Instance;
